...
/***/ function(module, exports, __webpack_require__) {
	...
	var _addtabs = __webpack_require__(159);
	...
	var WeatherApp = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				null,
				React.createElement(_addtabs.AddTab, { addFunc: this.addTab }),
				React.createElement(
					'div',
					{ className: 'tabs' },
					this.mapArr(this)
				),
				React.createElement(_view.WeatherView, { fullWeather: this.state.fullWeather })
			);
		}
	});

	_reactDom2.default.render(React.createElement(WeatherApp, null), document.getElementById("container"));
...
/***/ function(module, exports) {
	...
	var AddTab = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'sectionForAddTab' },
				React.createElement('input', { id: 'cityName' }),
				React.createElement(
					'button',
...
/***/ function(module, exports) {
	...
	var Tab = exports.Tab = React.createClass({
		displayName: 'Tab',
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: this.props.current ? 'tab currentTab' : 'tab', onClick: this.handleTabChange },
				React.createElement('img', { src: 'https://2ip.ru/img/flags/' + this.props.tabLink.sys.country + '.gif', alt: 'ico' }),
				React.createElement(
					'span',
					{ className: 'city' },
